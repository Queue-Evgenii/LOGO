...
//---------------------------searchPageTextSliderCATEGORIES-------------------------

let searchPageTitle = document.querySelector('.search-page__title');
let searchPageCategories = document.querySelector('.categories-search');

searchPageTitle.addEventListener('click', function(){
	searchPageTitle.classList.toggle('_active');
	_slideToggle(searchPageCategories);
})
...
for (let index = 0; index < checkboxCategories.length; index++) {
	...
	checkboxCategory.addEventListener("click", function(event){
		checkboxCategory.classList.toggle('_active');
		
	let checkboxActiveCategories =  document.querySelectorAll('.checkbox._active');
	let searchPageTitle = document.querySelector('.search-page__title');
	...
	if (checkboxActiveCategories.length > 0) {
		console.log('ready');
		searchPageTitle.classList.add('_categories');
		let searchQuantity = document.querySelector('.search-page__quantity');
		searchQuantity.innerHTML = searchQuantity.getAttribute('data-text') + ' ' + checkboxActiveCategories.length;
		} else {
			console.log('non');
			searchPageTitle.classList.remove('_categories');
		}
	});
};
...
//----------------clickOnMobile/mouseenterOnPC--ProductList------------------------------
...
if (document.querySelector('.brands-slider')) {
	new Swiper('.brands-slider_swiper', {
		navigation: {
...
let aboutTitle = document.querySelector('.about-block__title');
let aboutBlockText = document.querySelector('.about-block__row')

if (aboutTitle>0){
	if (window.matchMedia("(max-width: 992px)").matches){	
		aboutTitle.addEventListener('click', function(){
			aboutTitle.classList.toggle('_active');
			_slideToggle(aboutBlockText, 300);
		})
	}
}
...
let headerMenuBurger = document.querySelector('.icon-menu');
let headerMenuBody = document.querySelector('.menu__body');
let body = document.body;

headerMenuBurger.addEventListener('click', function(){
	headerMenuBurger&&headerMenuBody.classList.toggle('_active');
...
// SPOLLERS 
const spollersBlock = document.querySelector('.filter__body');
const spollersTitles = document.querySelectorAll('._spoller-title');
const spollersBody = document.querySelector('._spoller-body')

for (let index = 0; index < spollersTitles.length; index++) {
	const spollersTitle = spollersTitles[index];

	spollersTitle.addEventListener('click', function (event) {
		if (spollersBlock.classList.contains('_spollers')) {
			spollersTitle.classList.toggle('_active');
			spollersTitle.classList.toggle('_blk');
			_slideToggle(spollersTitle.nextElementSibling, 300);
		}
	});
}
...
document.querySelectorAll('.select').forEach(function (selectWrapper) {
	...
	let selectInput = selectWrapper.querySelector('.select-input');

	selectButton.addEventListener('click', function (e) {
		selectButton.classList.toggle('_active');
	...
	prices.forEach(function (input, handle) {
		input.addEventListener('change', function () {
			...
			if (priceStart.value > 0) {
				priceStart.addEventListener('focus', function () {
					priceStart.value = '';
				})
			}
			if (priceEnd.value > 0) {
				priceEnd.addEventListener('focus', function () {
					priceEnd.value = '';
				})
			}
		});
...
if (window.matchMedia("(max-width: 992px)").matches) {
	...
	filterTitle.addEventListener('click', function (e) {
		...
		_slideToggle(filterTitle.nextElementSibling, 300);
	});
};
